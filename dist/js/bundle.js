...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var questionsTitle = document.querySelector('#question');
  var formAnswers = document.querySelector('.form-answers');
  var quizContent = document.querySelector('.quiz-content');
  var answerImage = document.querySelector('.answer-image');
  var formWrapper = document.querySelector('.form-wrapper');
  var formFooterText = document.querySelector('.form-footer__text');
  var questions = [{
  ...
  var playTest = function playTest() {
    var finalAnswers = [];
    var numberQuestion = 0;

    var renderAnswers = function renderAnswers(index) {
      questions[index].answers.forEach(function (answer) {
        ...
        answerItem.innerHTML = "\n        <input type=\"".concat(questions[index].type, "\" id=\"").concat(answer.title, "\" name=\"answer\" value=\"").concat(answer.title, "\">\n        <label for=\"").concat(answer.title, "\">\n          <span>").concat(answer.title, "</span>\n        </label>\n        ");
    ...
    var renderQuestions = function renderQuestions(indexQuestion) {
      ...
      switch (true) {
        case numberQuestion >= 0 && numberQuestion < questions.length - 1:
          questionsTitle.textContent = "".concat(questions[indexQuestion].question);
    ...
    var checkAnswer = function checkAnswer() {
      ...
      var inputs = _toConsumableArray(formAnswers.elements).filter(function (input) {
        return input.checked || input.id == 'lastQuestion';
      });

      inputs.forEach(function (input, index) {
        if (numberQuestion >= 0 && numberQuestion <= questions.length - 1) {
          obj["".concat(index, "_").concat(questions[numberQuestion].question)] = input.value;
        }

        if (numberQuestion === questions.length - 1) {
          var connerctionForm = document.forms.connectionData;
          console.log(connerctionForm);
          var userName = document.querySelector('#userName');
          var numberPhone = document.querySelector('#numberPhone');
